...
export const fetchAPI = async (query, auth_token) => {
  try {
    const result = await fetch('https://apicollections.parismusees.paris.fr/graphql', {
      method: 'POST',
      headers: {
    ...
    throw createError(500, "An error occured while fetching data from apicollections.parismusees.paris.fr")
  }
}